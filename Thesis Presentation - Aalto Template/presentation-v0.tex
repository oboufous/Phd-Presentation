...
\vspace{-0.1cm}
A constrained correlated equilibrium of $G$ is a triplet $(d,\mathcal{R}_d,\bm{\alpha}^*)$ where $d$ is a correlation device, $\mathcal{R}_d$ is a coupled constraint set in $G_d$ and $\bm{\alpha}^*$ a correlated strategy profile such that, $\bm{\alpha}^* \in \mathcal{R}_d$ and for any 
    $i \in \mathcal{N}$, for any $\alpha^\prime_{i} \in \mathcal{S}_{i,d}$ such that $(\alpha_i^\prime, \bm{\alpha}^*_{-i}) \in \mathcal{R}_d$,
    \vspace{-0cm}
    %%%%%%%%%%%%%%%%%%%
    \begin{equation}
        \sum 
